			...
			<body>
				<div class="main">
					...
					<table width="1200" class="reports">
						...
						<xsl:for-each select="svrl:successful-report">
							<xsl:choose>
								...
								<xsl:when test="not(@role='Priority1')">
									<tr>
										<td style="width:5%">
											<xsl:value-of select="@id"/>
										</td>
					...
					<table width="1200" class="priority1">
						...
						<xsl:for-each select="svrl:successful-report[@role='Priority1']">
							<tr>
								<td style="width:5%">
									<xsl:value-of select="@id"/>
								</td>
					...
					<p>© 2008 <a href="http://uncpress.unc.edu/">The University of North Carolina
							Press</a></p>
				</div>
			</body>
		</html>
